...
if [ $dgmethod = "ftp" ] ; then
    ...
    curl -O -u dg:afruit ftp://192.168.88.94:2141//var/varvamp/files/vne.sh
    ...
    if [ ! -f htdocs.PMDS-DATA.latest.7z ] ; then
        ...
        curl -O -u dg:afruit ftp://192.168.88.94:2141//var/varvamp/files/htdocs.PMDS-DATA.latest.7z
