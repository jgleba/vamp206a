...
sudo crontab -u albe -l | { cat; echo "54 10 * * 1-7  /var/www/html/prodrpt/actions/sendemail_recentdowntime3.sh >> /home/albe/log/sendrecentdowntime3.log 2<&1"; } | sudo crontab -u albe -  #add
sudo crontab -u albe -l  # list
