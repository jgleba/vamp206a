...
:to get prompt for password use -p, use --password=x for no prompt
...
C:\p\1ziptar\7-Zip\7z.exe a -y -tzip -xr!templates_c  -xr!testnobackup "c:\backup\htdocs\htdocs.%computername%.latest.zip" C:\p2\xampp\htdocs\
